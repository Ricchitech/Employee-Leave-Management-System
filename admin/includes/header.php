...
<marquee width="950px" direction="left" behavior="alternate" >
<span style="font-size:38px; width=''font-weight:bold;color:#1F7A8C;font-family:'lobster', cursive;">Employee Leave Management System</span>
        </marquee>
