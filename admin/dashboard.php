                             ...
                             <table id="example" class="display responsive-table bg-transparent">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="240" class="text-danger">Employe Name</th>
                                            <th width="180" class="text-danger">Leave Type</th>
                                             <th width="180" class="text-danger">Posting Date</th>                 
                                            <th width="100" class="text-danger">Status</th>
